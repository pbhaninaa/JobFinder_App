...
import { Styles,mediaBtn,primaryColor, ratingStarColor } from '../../Styles'
    ...
    return (
      <View style={Styles.body}>
          ...
          <View style={{ gap: 15 }}>
            <Text style={Styles.helloText}>
              ...
              {loggedUser.gender.toLowerCase() === "male"
                ...
                ? " Miss" + loggedUser.surname
                : " Mrss" + loggedUser.surname}
            </Text>
            ...
            source={{
              uri:
                loggedUser.image == null
                  ? "https://www.fintechfutures.com/files/2019/07/synechron.png"
                  : loggedUser.image,
            }}
            resizeMode="contain"
        ...
        <View style={Styles.cardContainer}>
          ...
          <View style={Styles.progressContainer}>
            {/* navigation.navigate('Profile', { data: loggedUser })} */}
            <TouchableOpacity
              style={Styles.icon}
              onPress={() =>
                navigation.navigate("Create", { data: loggedUser })
              }
            >
              <AntDesign
                name="right"
        ...
        <View style={Styles.headerView}>
          <View style={Styles.blueCard}>
            ...
            <Text style={Styles.Cardtexts}>Jobs Applied</Text>
          </View>
          <View style={Styles.pinkCard}>
            <Text style={Styles.Cardnumber}>
              {loggedUser.interviews.length}
            </Text>
            <Text style={Styles.Cardtexts}>Interviews</Text>
          </View>
        </View>
        <View style={Styles.headerView}>
              ...
              >
                <View style={Styles.flex}>
                  ...
                  <View style={Styles.postDetails}>
                    ...
                    <Text style={Styles.dashboardText} numberOfLines={1}>
                      {JobTittleSubString(job?.job_title)}
                    </Text>
                    <Text style={{ fontSize: 20, color: "lightgrey" }}>
                      {job?.job_city}.{job?.job_state}.{job?.job_country}
                    </Text>
                    <Text style={{ fontSize: 20, color: "lightgrey" }}>
                      Languege: {job?.job_posting_language}
                    </Text>
                  </View>
                </View>
                <View style={Styles.flex}>
                  ...
                  <View style={Styles.rate}>
                    ...
                    />
                    <Text style={{ color: ratingStarColor }}>
                      {job.company_rate}
                    </Text>
                  </View>
                </View>
